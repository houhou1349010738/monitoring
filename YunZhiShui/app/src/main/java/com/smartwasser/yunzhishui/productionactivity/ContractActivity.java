...
import com.smartwasser.yunzhishui.bean.ProductMenuResponse;
 ...
 */
public class ContractActivity extends BaseActivity implements View.OnClickListener,HttpLoader.ResponseListener{
    ...
    private Button   but_reimburse_search,but_reimburse_chongzhi;
    ...
    protected void initData() {
        ...
        tv_toolbar_centext.setText("收款通知");
        /**
         * 设置下拉刷新的颜色
         */
                ...
                if("00000".equals(mSkContract.getErrorCode())) {
                    ...
                    list_contract.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                            ...
                            Intent intent = new Intent(ContractActivity.this, ContractDetailsActicity.class);
    ...
    class MyScheduleAdapter extends BaseAdapter{
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                convertView = View.inflate(ContractActivity.this, R.layout.item_search, null);
    ...
    class MyContracAdapter extends BaseAdapter{
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ViewHolder holder;
            if(convertView==null){
                convertView=View.inflate(ContractActivity.this,R.layout.item_contract,null);
                holder=new ViewHolder();
            ...
            holder.tv_contract_ssxm.setText("所属项目:" + "  " + lists.get(position).getUnitName());
