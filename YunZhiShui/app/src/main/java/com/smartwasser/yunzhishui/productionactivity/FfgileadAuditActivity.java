...
import com.smartwasser.yunzhishui.fragment.AllFfgiFragment;
import com.smartwasser.yunzhishui.fragment.FfgiLeadFragment;
 ...
 */
public class FfgileadAuditActivity extends FragmentActivity implements View.OnClickListener,HttpLoader.ResponseListener{
    private AllFfgiFragment mReimburse;
    private ImageView iv1;
    private float moveTo=0.0f;
    private FfgiLeadFragment mPendingAuditFragment;
    ...
    public void onClick(View v) {
        switch(v.getId()){
            case R.id.tv_mei1:
                ...
                break;
            case R.id.tv_mei2:
                mPendingAuditFragment=new FfgiLeadFragment();
                getSupportFragmentManager().
                        beginTransaction()
    ...
    class MyBusinessAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                convertView = View.inflate(FfgileadAuditActivity.this, R.layout.item_search, null);
