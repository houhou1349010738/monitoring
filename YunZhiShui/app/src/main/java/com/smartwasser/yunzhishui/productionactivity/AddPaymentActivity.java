 ...
 */
public class AddPaymentActivity extends BaseActivity implements View.OnClickListener,HttpLoader.ResponseListener,AbsListView.OnScrollListener{
    ...
    public void onEvent(PaymentDetaulResponse mContractDetail){
        ...
        switch (v.getId()) {
            ...
            case R.id. but_addreimbures_save:
                ...
                if("".equals(fplx)||fplx==null||"null".equals(fplx)){
                    Toast.makeText(AddPaymentActivity.this, "请选择发票类型", Toast.LENGTH_SHORT).show();
                    return;
                }
                if(fplx.equals("增值税普通发票")){
                    ...
                    if("".equals(zfje)||zfje==null||"null".equals(zfje)){
                        Toast.makeText(AddPaymentActivity.this, "请填写支付金额", Toast.LENGTH_SHORT).show();
                        return;
                    }
                    ...
                    if(je==null||"".equals(je)){
                        Toast.makeText(AddPaymentActivity.this, "请填写金额", Toast.LENGTH_SHORT).show();
                        return;
                    }
                    if(sl==null||"".equals(sl)){
                        Toast.makeText(AddPaymentActivity.this, "请填写税率", Toast.LENGTH_SHORT).show();
                        return;
                    }
                    /**添加3个参数*/
                ...
                if("".equals(skdw)||skdw==null||"null".equals(skdw)){
                    Toast.makeText(AddPaymentActivity.this, "请填写收款单位", Toast.LENGTH_SHORT).show();
                    return;
                }
                String sqrq=ed_addreimbures_sqsj.getText().toString();
                if("".equals(sqrq)||sqrq==null||"null".equals(sqrq)){
                    Toast.makeText(AddPaymentActivity.this, "请选择申请时间", Toast.LENGTH_SHORT).show();
                    return;
                }
                String zfsm=ed_addreimbures_zfsm.getText().toString();
                if("".equals(zfsm)||zfsm==null||"null".equals(zfsm)){
                    Toast.makeText(AddPaymentActivity.this, "请填写支付说明", Toast.LENGTH_SHORT).show();
                    return;
                }
                /**如果金额不等于报销金额则不能添加*/
                if(fplx.equals("增值税专用发票")){
                    if (m != Double.parseDouble(ed_addreimbures_je.getText().toString())) {
                        Toast.makeText(AddPaymentActivity.this, "业务科目金额和申请金额不相等", Toast.LENGTH_SHORT).show();
                        return;
                    }
                }else{
                ...
                HttpLoader.get(ConstantsYunZhiShui.URL_TYPEMASTERSAVEZF, prams,
                        SaveResponse.class, ConstantsYunZhiShui.REQUEST_CODE_TYPEMASTERSAVEZF, this, false).setTag(this);
                break;
        }
    }
    @Override
    public void onGetResponseSuccess(int requestCode, RBResponse response) {
        ...
        if (requestCode == ConstantsYunZhiShui.REQUEST_CODE_TYPEMASTERYWKMJY
            ...
            if ("00000".equals(IsFill.getErrorCode())) {
                ...
                HttpLoader.get(ConstantsYunZhiShui.URL_TYPEMASTERADDTOINDE, prams,
                        BusinessResponse.class, ConstantsYunZhiShui.REQUEST_CODE_TYPEMASTERADDTOINDE, AddPaymentActivity.this, false).setTag(this);
            }
        }
        ...
        if (requestCode == ConstantsYunZhiShui.REQUEST_CODE_TYPEMASTERSAVEZF
    ...
    class MyAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, final ViewGroup parent) {
            if(convertView==null){
                convertView=View.inflate(AddPaymentActivity.this,R.layout.item_yewukemu,null);
                ...
                public void onClick(View v) {
                    ...
                    if ("".equals(sqsj) || "null".equals(sqsj) || sqsj == null) {
                        ...
                        HttpLoader.get(ConstantsYunZhiShui.URL_TYPEMASTERYWKMJY, prams,
                                IsFillResponse.class, ConstantsYunZhiShui.REQUEST_CODE_TYPEMASTERYWKMJY, AddPaymentActivity.this, false).setTag(this);
                    }
                }
            });
            return convertView;
    ...
    class MyAdapters extends BaseAdapter{
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ViewHolder holder;
            if(convertView==null){
                convertView=View.inflate(AddPaymentActivity.this,R.layout.item_business,null);
                holder=new ViewHolder();
