...
import com.smartwasser.yunzhishui.pager.RmonPager;
 ...
 */
public class RmonFragment extends MainBaseFragment{
    ...
    public View initView(LayoutInflater inflater) {
        ...
        tv_toolbar_report.setText("远程监控");
        return view;
    }
    @Override
    public void initData() {
        ...
        /**首页*/
        mListPager.add(new RmonPager(getActivity()));
        /**个人中心*/
