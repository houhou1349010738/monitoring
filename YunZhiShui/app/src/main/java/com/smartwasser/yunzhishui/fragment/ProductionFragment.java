...
import com.smartwasser.yunzhishui.pager.DevicePager;
 ...
 */
public class ProductionFragment extends MainBaseFragment{
    ...
    public View initView(LayoutInflater inflater) {
        ...
        tv_toolbar_report.setText("生产成本管理系统");
        return view;
    }
    ...
    public void initData() {
        ...
        /**首页*/
        mListPager.add(new ProductionPager(getActivity()));
        /**个人中心*/
