 ...
 */
public class ContractLookActivity extends BaseActivity implements HttpLoader.ResponseListener{
                      ...
                      button_contract.setOnClickListener(new View.OnClickListener() {
                          ...
                          public void onClick(View v) {
                              ...
                              HttpLoader.get(ConstantsYunZhiShui.URL_TYPEMASTERFEETJ, prams,
                                      SaveResponse.class, ConstantsYunZhiShui.REQUEST_CODE_TYPEMASTERFEETJ,ContractLookActivity.this, false).setTag(this);
                          }
                      });
                  }
                  /**请求网络*/
        ...
        if (requestCode == ConstantsYunZhiShui.REQUEST_CODE_TYPEMASTERFEETJ
            ...
            SaveResponse mSave = (SaveResponse) response;
                if("00000".equals(mSave.getErrorCode())){
                    Intent intent=new Intent(ContractLookActivity.this,ContractActivity.class);
    ...
    class MyDetailAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ViewHolder holder;
            if(convertView==null){
                convertView=View.inflate(ContractLookActivity.this,R.layout.item_ywkm,null);
