 ...
 */
public class PaymentActivity extends BaseActivity implements View.OnClickListener,HttpLoader.ResponseListener{
    ...
    private Button but_enlist_chongzhi;
    ...
    private View getViews(){
        View view=View.inflate(this,R.layout.popup_payment,null);
    ...
    protected void initData() {
        ...
        tv_toolbar_centext.setText("支付申请");
        /**请求网络*/
        HashMap<String, Object> prams = new HashMap<>();
        prams.put("page",1);
        prams.put("fundsType","ZF");
            ...
            if("00000".equals(mSkContract.getErrorCode())) {
                ...
                list_contract.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        Intent intent = new Intent(PaymentActivity.this, PaymentDetailsActicity.class);
    ...
    class MyScheduleAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                convertView = View.inflate(PaymentActivity.this, R.layout.item_search, null);
    ...
    class MyContracAdapter extends BaseAdapter{
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ViewHolder holder;
            if(convertView==null){
                convertView=View.inflate(PaymentActivity.this,R.layout.item_contract,null);
                holder=new ViewHolder();
