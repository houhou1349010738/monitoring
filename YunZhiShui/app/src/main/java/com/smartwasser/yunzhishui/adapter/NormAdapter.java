...
public class NormAdapter extends BaseAdapter{
    ...
    private List<IndeFindReaponse.DataEntity.DailyIndeListEntity> mList;
    public NormAdapter(Context context,List<IndeFindReaponse.DataEntity.DailyIndeListEntity> mList){
        mContext=context;
        this.mList=mList;
    }
    @Override
