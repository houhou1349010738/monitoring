...
import com.smartwasser.yunzhishui.pager.PurchasePager;
 ...
 */
public class PurchaseFragment extends MainBaseFragment{
    ...
    public View initView(LayoutInflater inflater) {
        ...
        tv_toolbar_report.setText("采购管理系统");
        return view;
    }
    ...
    public void initData() {
        ...
        /**首页*/
        mListPager.add(new PurchasePager(getActivity()));
        /**个人中心*/
