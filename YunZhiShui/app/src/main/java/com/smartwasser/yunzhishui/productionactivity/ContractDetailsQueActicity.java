 ...
 */
public class ContractDetailsQueActicity extends BaseActivity implements HttpLoader.ResponseListener{
    ...
    public void onGetResponseSuccess(int requestCode, RBResponse response) {
        if (requestCode == ConstantsYunZhiShui.REQUEST_CODE_TYPEMASTERSKFIND
             ...
             if("00000".equals(mContractDetail.getErrorCode())){
                 ...
                 tv_contract_wsje.setText("￥"+mContractDetail.getData().getPo().getProfessionSubject());
        ...
        if (requestCode == ConstantsYunZhiShui.REQUEST_CODE_TYPEMASTERFINDFEESK
            ...
            if("00000".equals(mDetailsList.getErrorCode())){
    ...
    class MyAdapter extends BaseAdapter{
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ViewHolder holder;
            if(convertView==null){
                convertView=View.inflate(ContractDetailsQueActicity.this,R.layout.item_contract_detail,null);
                ...
                holder.querenann= (Button) convertView.findViewById(R.id.querenann);
            ...
            holder.chakan.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(ContractDetailsQueActicity.this, ContractLookQueActivity.class);
                    startActivity(intent);
                }
            });
            holder.querenann.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    /**将这些值传过去*/
        ...
        class ViewHolder{
            ...
            Button bianji,queding,chakan,querenann;
        }
    }
    @Override
