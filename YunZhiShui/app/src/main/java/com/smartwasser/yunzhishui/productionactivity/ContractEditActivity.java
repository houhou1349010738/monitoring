 ...
 */
public class ContractEditActivity extends BaseActivity implements View.OnClickListener,HttpLoader.ResponseListener,AbsListView.OnScrollListener{
    ...
    protected void initData() {
        ...
        mContractDetail=event.getmContractDetail();
        tv_toolbar_zhu.setText("生产成本");
        tv_toolbar_centext.setText("收款通知修改");
        ...
        switch (v.getId()) {
            ...
            case R.id.but_addreimbures_save:
                ...
                if("".equals(fplx)||fplx==null||"null".equals(fplx)){
                    Toast.makeText(ContractEditActivity.this, "请选择发票类型", Toast.LENGTH_SHORT).show();
                    return;
                }
                if("".equals(sl)||sl==null||"null".equals(sl)){
                    Toast.makeText(ContractEditActivity.this, "请填写税率", Toast.LENGTH_SHORT).show();
                    return;
                }
                if("".equals(se)||se==null||"null".equals(se)){
                    Toast.makeText(ContractEditActivity.this, "请填写税额", Toast.LENGTH_SHORT).show();
                    return;
                }
                if("".equals(skjes)||skjes==null||"null".equals(skjes)){
                    Toast.makeText(ContractEditActivity.this, "请填写收款金额", Toast.LENGTH_SHORT).show();
                    return;
                }
                if("".equals(kpdw)||kpdw==null||"null".equals(kpdw)){
                    Toast.makeText(ContractEditActivity.this, "请填写开票单位", Toast.LENGTH_SHORT).show();
                    return;
                }
                if("".equals(dzyh)||dzyh==null||"null".equals(dzyh)){
                    Toast.makeText(ContractEditActivity.this, "请填写到账银行", Toast.LENGTH_SHORT).show();
                    return;
                }
                if("".equals(nsrsbh)||nsrsbh==null||"null".equals(nsrsbh)){
                    Toast.makeText(ContractEditActivity.this, "请填写纳税识别号", Toast.LENGTH_SHORT).show();
                    return;
                }
                if("".equals(khhmc)||khhmc==null||"null".equals(khhmc)){
                    Toast.makeText(ContractEditActivity.this, "请填写开户行名称", Toast.LENGTH_SHORT).show();
                    return;
                }
                if("".equals(khhzh)||khhzh==null||"null".equals(khhzh)){
                    Toast.makeText(ContractEditActivity.this, "请填写开户行账号", Toast.LENGTH_SHORT).show();
                    return;
                }
                if("".equals(sqrq)|| sqrq==null||"null".equals(sqrq)){
                    Toast.makeText(ContractEditActivity.this, "请选择申请日期", Toast.LENGTH_SHORT).show();
                    return;
                }

                if("".equals(dwdz)||dwdz==null||"null".equals(dwdz)){
                    Toast.makeText(ContractEditActivity.this, "请填写单位地址", Toast.LENGTH_SHORT).show();
                    return;
                }
                if("".equals(sksm)||sksm==null||"null".equals(sksm)){
                    Toast.makeText(ContractEditActivity.this, "请填写收款说明", Toast.LENGTH_SHORT).show();
                    return;
                }
                if("".equals(lxfs)||lxfs==null||"null".equals(lxfs)){
                    Toast.makeText(ContractEditActivity.this, "请填写联系方式", Toast.LENGTH_SHORT).show();
                    return;
                }
                /**发起网络请求*/
                HashMap<String, Object> prams = new HashMap<>();
                ...
                if(m!=Double.parseDouble(ed_addreimbures_skjes.getText().toString())){
                    Toast.makeText(ContractEditActivity.this, "业务科目金额和申请金额不相等", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                prams.put("id",event.getContractId());
                HttpLoader.get(ConstantsYunZhiShui.URL_TYPEMASTERUPDATESk, prams,
                        SaveResponse.class, ConstantsYunZhiShui.REQUEST_CODE_TYPEMASTERUPDATESk, this, false).setTag(this);
                break;
            case R.id.tianjia:
    ...
    public void onGetResponseSuccess(int requestCode, RBResponse response)    {
        if (requestCode == ConstantsYunZhiShui.REQUEST_CODE_TYPEMASTERVIEWSK
            ...
            if("00000".equals( mContractLook.getErrorCode())){
                if(!"".equals(mContractLook.getData().getInv())&&!"null".equals(mContractLook.getData().getInv())&&
                    ...
                    if (ts.equals("ZY")) {
                        m = "增值税专用发票";
                    } else if (ts.equals("PT")) {
                        m = "增值税普通发票";
                    } else if (ts.equals("QT")) {
                        m = "其他发票";
                    }
                    ed_addreimbures_fplx.setVisibility(View.VISIBLE);
                    ed_addreimbures_skjes.setVisibility(View.VISIBLE);
                    ed_addreimbures_fplx.setText(m);
                    ed_addreimbures_sl.setVisibility(View.VISIBLE);
                    ed_addreimbures_se.setVisibility(View.VISIBLE);
                    ed_addreimbures_skjes.setText(mContractLook.getData().getInv().getInvoiceMoney()+"");
                ...
                tv_addreimbures_sqr.setText("申请人:"+mContractLook.getData().getVo().getApplyUsernamecn());
                ed_addreimbures_je.setText(mContractLook.getData().getVo().getIncomeMoney()+"");
                ed_addreimbures_sqbxje.setText(mContractLook.getData().getVo().getBank());
                ed_addreimbures_sqjedx.setText(mContractLook.getData().getVo().getOrganizationName());
                ed_addreimbures_bxsm.setText(mContractLook.getData().getVo().getTaxpayer());
                ed_addreimbures_khhmc.setText(mContractLook.getData().getVo().getBankName());
                ed_addreimbures_khhzh.setText(mContractLook.getData().getVo().getBankNumber());
                ed_addreimbures_dwdz.setText(mContractLook.getData().getVo().getOrganizationAdd());
                ed_addreimbures_sksm.setText(mContractLook.getData().getVo().getIncomeSummary());
                ed_addreimbures_lxfs.setText(mContractLook.getData().getVo().getPhone());
                               /**请求网络*/
                HashMap<String, Object> prams = new HashMap<>();
        ...
        if (requestCode == ConstantsYunZhiShui.REQUEST_CODE_TYPEMASTERYWKMJY
            ...
            if ("00000".equals(IsFill.getErrorCode())) {
                ...
                prams.put("page", page);
                HttpLoader.get(ConstantsYunZhiShui.URL_TYPEMASTERADDTOINDE, prams,
                        BusinessResponse.class, ConstantsYunZhiShui.REQUEST_CODE_TYPEMASTERADDTOINDE,ContractEditActivity.this, false).setTag(this);
            }
        }
        ...
        if (requestCode == ConstantsYunZhiShui.REQUEST_CODE_TYPEMASTERUPDATESk
                && response instanceof SaveResponse) {
            SaveResponse msave = (SaveResponse) response;
            if("00000".equals(msave.getErrorCode())){
                /**跳转到首页*/
                Intent intent=new Intent(ContractEditActivity.this,ContractActivity.class);
    ...
    class MyBinkAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                convertView = View.inflate(ContractEditActivity.this, R.layout.item_search, null);
    ...
    class MyAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, final ViewGroup parent) {
            if(convertView==null){
                convertView=View.inflate(ContractEditActivity.this,R.layout.item_yewukemu,null);
                holder=new ViewHolder();
            ...
            holder.but_xuanze.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if ("".equals(sqsj) || "null".equals(sqsj) || sqsj == null) {
                        Toast.makeText(ContractEditActivity.this, "请选择申请时间", Toast.LENGTH_SHORT).show();
                        return;
                    } else {
                        /**调用校验接口*/
                        HashMap<String, Object> prams = new HashMap<>();
                        ...
                        HttpLoader.get(ConstantsYunZhiShui.URL_TYPEMASTERYWKMJY, prams,
                                IsFillResponse.class, ConstantsYunZhiShui.REQUEST_CODE_TYPEMASTERYWKMJY, ContractEditActivity.this, false).setTag(this);
                    }
                }
            });
            return convertView;
    ...
    class MyAdapters extends BaseAdapter{
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ViewHolder holder;
            if(convertView==null){
                convertView=View.inflate(ContractEditActivity.this,R.layout.item_business,null);
                holder=new ViewHolder();
