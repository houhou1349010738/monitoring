 ...
 */
public class ReimburseAuditActivity extends FragmentActivity implements View.OnClickListener,HttpLoader.ResponseListener{
    private ReimburseFragment mReimburse;
    ...
    private void initData() {
        ...
        mReimburse=new  ReimburseFragment();
        image_add.setVisibility(View.GONE);
        image_serc.setOnClickListener(this);
        tv_toolbar_centext.setText(event.getTitleName());
    ...
    public void onClick(View v) {
        switch(v.getId()){
            case R.id.tv_mei1:
                ...
                break;
            case R.id.tv_mei2:
                mPendingAuditFragment=new  PendingAuditFragment();
                getSupportFragmentManager().
                        beginTransaction()
    ...
    class MyBusinessAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                convertView = View.inflate(ReimburseAuditActivity.this, R.layout.item_search, null);
