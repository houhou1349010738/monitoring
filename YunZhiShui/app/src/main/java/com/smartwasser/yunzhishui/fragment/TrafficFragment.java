...
import com.smartwasser.yunzhishui.pager.TrafficPager;
 ...
 */
public class TrafficFragment extends MainBaseFragment{
    ...
    public View initView(LayoutInflater inflater) {
        ...
        tv_toolbar_report.setText("污泥运输监控系统");
        return view;
    }
    ...
    public void initData() {
        ...
        /**首页*/
        mListPager.add(new TrafficPager(getActivity()));
        /**个人中心*/
